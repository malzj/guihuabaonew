...
<section id="container" >
    ...
    <section id="main-content">
        ...
        <div class="hxzs_heading clearfix">
            <h2>版本更新</h2>
            <g:form  action="banbenSave" method="post" enctype="multipart/form-data">
            ...
            %{--<script id="introduction"  name="introduction" type="text/plain" style="width:100%;height:500px;"></script>--}%
                <textarea id="editor_id" name="introduction" style="width:100%;height:500px;">${banben.introduction}</textarea>

                <g:hiddenField name="id" value="${banben?.id}" />
                <g:hiddenField name="version" value="${banben?.version}" />
