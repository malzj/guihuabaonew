    ...
    <section id="main-content">
        <section class="wrapper mt80">
            <div class="hxzs_heading clearfix">
                <h2>功能介绍</h2>
            <g:form  action="funIntroductionSave" method="post" enctype="multipart/form-data">
            ...
            <div class="mt25">
                <div class="textarea">
                    ...
                    %{--<script id="introduction"  name="introduction" type="text/plain" style="width:100%;height:500px;"></script>--}%
                            <textarea id="editor_id" name="introduction" style="width:100%;height:500px;">${funIntroduction.introduction}</textarea>

                        <g:hiddenField name="id" value="${funIntroduction?.id}" />
                        <g:hiddenField name="version" value="${funIntroduction?.version}" />
