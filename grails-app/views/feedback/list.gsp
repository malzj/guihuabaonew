			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="content" title="${message(code: 'feedback.content.label', default: 'Content')}" />
					
						<g:sortableColumn property="username" title="${message(code: 'feedback.username.label', default: 'Username')}" />
					
						<g:sortableColumn property="userId" title="${message(code: 'feedback.userId.label', default: 'User Id')}" />
