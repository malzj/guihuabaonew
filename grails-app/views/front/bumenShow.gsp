                        ...
                        <tr>
                            ...
                            <td align="right">
                                <g:form>
                                    ...
                                    <g:link controller="front" action="bumenEdit" id="${bumenInstance?.id}" class="btn btn-info">修改</g:link>
                                    <g:actionSubmit type="submit" class="btn btn-info" action="bumenDelete"  value="删除" onclick="return confirm('确定删除?');" />
                                </g:form>
                            </td>
                        </tr>
                    </table>
