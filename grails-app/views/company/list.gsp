			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="companyname" title="${message(code: 'company.companyname.label', default: 'Companyname')}" />
					
						<g:sortableColumn property="remark" title="${message(code: 'company.remark.label', default: 'Remark')}" />
						...
						<g:sortableColumn property="dateCreat" title="${message(code: 'company.dateCreat.label', default: 'Date Creat')}" />
					
						<g:sortableColumn property="dateUse" title="${message(code: 'company.dateUse.label', default: 'Date Use')}" />
				...
				<g:each in="${companyInstanceList}" status="i" var="companyInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${companyInstance.dateCreat}" /></td>
					
						<td><g:formatDate date="${companyInstance.dateUse}" /></td>
